...
ALTER PROFILE FIDE_ROYAL_ROOTS_PROF LIMIT SESSIONS_PER_USER 100 CONTAINER=ALL;
...
ALTER TABLE FIDE_TURNOS_TB MODIFY (HORA_INICIO TIMESTAMP);
ALTER TABLE FIDE_TURNOS_TB MODIFY (HORA_FIN TIMESTAMP);
...
ALTER TABLE FIDE_PROVEEDOR_TB DROP COLUMN ID_DIRECCION;
ALTER TABLE FIDE_PROVEEDOR_TB
DROP CONSTRAINT FIDE_PROVEEDOR_TB_ID_DIRECCION_FK;
...
FOR EACH ROW
BEGIN
  :NEW.ID_FACTURA := FIDE_FACTURAS_TB_SEQ.NEXTVAL;
END;
/
