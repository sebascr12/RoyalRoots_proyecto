...
-- Módulo Empleados
FUNCTION FIDE_ESTADO_TB_OBTENER_ID_ESTADO_FN(p_descripcion VARCHAR2) RETURN NUMBER IS
V_ID_ESTADO NUMBER;
BEGIN
...
PROCEDURE FIDE_ESTADO_TB_LISTAR_ESTADOS_SP(p_cursor OUT SYS_REFCURSOR) IS
BEGIN
    OPEN p_cursor FOR
        SELECT DESCRIPCION
        FROM FIDE_ESTADO_TB
...
FUNCTION FIDE_EMPLEADOS_FUNCION_TB_OBTENER_ID_FUNCION_FN(p_nombre_funcion VARCHAR2) RETURN NUMBER IS
  v_id_funcion NUMBER;
BEGIN
...
FUNCTION FIDE_TURNOS_TB_OBTENER_ID_TURNO_FN(p_inicio DATE, p_fin DATE) RETURN NUMBER IS
  v_id_turno NUMBER;
BEGIN
...
FUNCTION FIDE_EMPLEADOS_TB_OBTENER_ID_EMPLEADO_FN(p_correo IN VARCHAR2) RETURN NUMBER IS
...
PROCEDURE FIDE_EMPLEADOS_TB_ELIMINAR_EMPLEADO_SP (
    p_correo IN VARCHAR2
) AS
    v_empleado_id NUMBER;
...
PROCEDURE FIDE_EMPLEADOS_TB_LISTAR_EMPLEADOS_SP (
...
PROCEDURE FIDE_TURNOS_TB_LISTAR_TURNOS_SP(
    p_resultado OUT SYS_REFCURSOR
) AS
BEGIN
    OPEN p_resultado FOR
...
PROCEDURE FIDE_EMPLEADOS_FUNCION_TB_INACTIVAR_SP (
    p_nombre_funcion IN VARCHAR2
) AS
    v_id_estado NUMBER;
BEGIN
...
PROCEDURE FIDE_EMPLEADOS_FUNCION_TB_LISTAR_SP (
    p_resultado OUT SYS_REFCURSOR
) AS
BEGIN
    OPEN p_resultado FOR
...
PROCEDURE FIDE_VACACIONES_TB_LISTAR_SP (
    p_resultado OUT SYS_REFCURSOR
) AS
BEGIN
    OPEN p_resultado FOR
...
PROCEDURE FIDE_EMPLEADOS_TB_LISTAR_CORREOS_SP (
    p_cursor OUT SYS_REFCURSOR
) AS
BEGIN
    OPEN p_cursor FOR
        SELECT ADMIN_CORREO FROM FIDE_EMPLEADOS_TB 
        WHERE ID_ESTADO = FIDE_ESTADO_TB_OBTENER_ID_ESTADO_FN('ACTIVO');
END;
...
PROCEDURE FIDE_RESERVAS_TB_LISTAR_SP (
    p_resultado OUT SYS_REFCURSOR
) AS
BEGIN
    OPEN p_resultado FOR
...
PROCEDURE FIDE_RESERVAS_TB_INACTIVAR_SP (
...
PROCEDURE FIDE_CLIENTES_TB_LISTAR_NOMBRES_SP (
    p_cursor OUT SYS_REFCURSOR
) AS
BEGIN
    OPEN p_cursor FOR
        SELECT NOMBRE_CLIENTE FROM FIDE_CLIENTES_TB 
        WHERE ID_ESTADO = FIDE_ESTADO_TB_OBTENER_ID_ESTADO_FN('ACTIVO');
END;

PROCEDURE FIDE_SERVICIOS_TB_LISTAR_NOMBRES_SP (
    p_resultado OUT SYS_REFCURSOR
) AS
BEGIN
    OPEN p_resultado FOR
...
PROCEDURE FIDE_PROVINCIA_TB_LISTAR_PROVINCIAS_SP (
    p_resultado OUT SYS_REFCURSOR
) AS
BEGIN
    OPEN p_resultado FOR
...
PROCEDURE FIDE_PROVINCIA_TB_INACTIVAR_PROVINCIA_SP (
    p_nombre_provincia IN VARCHAR2
) AS
...
FUNCTION FIDE_PROVINCIA_TB_OBTENER_ID_PROVINCIA_FN (
    p_nombre_provincia IN VARCHAR2
) RETURN NUMBER
IS
    v_id NUMBER;
...
PROCEDURE FIDE_CANTON_TB_LISTAR_SP (
    p_resultado OUT SYS_REFCURSOR
) AS
BEGIN
    OPEN p_resultado FOR
...
PROCEDURE FIDE_CANTON_TB_INACTIVAR_SP (
    p_nombre_canton IN VARCHAR2
) AS
    v_id_estado NUMBER;
BEGIN
...
FUNCTION FIDE_CANTON_TB_OBTENER_ID_CANTON_FN (
    p_nombre_canton IN VARCHAR2
) RETURN NUMBER
IS
    v_id NUMBER;
...
PROCEDURE FIDE_DISTRITO_TB_LISTAR_SP (
    p_resultado OUT SYS_REFCURSOR
) AS
BEGIN
    OPEN p_resultado FOR
...
PROCEDURE FIDE_DISTRITO_TB_INACTIVAR_SP (
    p_nombre_distrito IN VARCHAR2
) AS
    v_id_estado NUMBER;
BEGIN
...
FUNCTION FIDE_DISTRITO_TB_OBTENER_ID_DISTRITO_FN (
    p_nombre_distrito IN VARCHAR2
) RETURN NUMBER
IS
    v_id NUMBER;
...
FUNCTION FIDE_PROVINCIA_TB_LISTAR_ACTIVAS_FN
...
FUNCTION FIDE_CANTON_TB_LISTAR_ACTIVOS_FN
RETURN SYS_REFCURSOR IS
    resultado SYS_REFCURSOR;
BEGIN
    OPEN resultado FOR
...
FUNCTION FIDE_DISTRITO_TB_LISTAR_ACTIVOS_FN
RETURN SYS_REFCURSOR IS
    resultado SYS_REFCURSOR;
BEGIN
    OPEN resultado FOR
...
PROCEDURE FIDE_DIRECCION_TB_LISTAR_SP (
    p_resultado OUT SYS_REFCURSOR
)
AS
BEGIN
...
PROCEDURE FIDE_DIRECCION_TB_INACTIVAR_SP (
    p_id_direccion IN NUMBER
)
AS
    v_id_estado NUMBER;
...
FUNCTION FIDE_DIRECCION_TB_OBTENER_ID_DIRECCION_FN (
...
FUNCTION FIDE_DIRECCION_TB_LISTAR_COMO_DESCRIPCION_FN
...
FUNCTION FIDE_DIRECCION_TB_OBTENER_PROVINCIA_FN (
    p_id_direccion IN NUMBER
) RETURN VARCHAR2
IS
    v_provincia VARCHAR2(100);
...
FUNCTION FIDE_DIRECCION_TB_OBTENER_CANTON_FN (
    p_id_direccion IN NUMBER
) RETURN VARCHAR2
IS
    v_canton VARCHAR2(100);
BEGIN
    SELECT C.CANTON INTO v_canton
    FROM FIDE_DIRECCION_TB D
    JOIN FIDE_CANTON_TB C ON D.ID_CANTON = C.ID_CANTON
    WHERE D.ID_DIRECCION = p_id_direccion;
    RETURN v_canton;
...
FUNCTION FIDE_DIRECCION_TB_OBTENER_DISTRITO_FN (
    p_id_direccion IN NUMBER
) RETURN VARCHAR2
IS
    v_distrito VARCHAR2(100);
BEGIN
    SELECT DI.DISTRITO INTO v_distrito
    FROM FIDE_DIRECCION_TB D
    JOIN FIDE_DISTRITO_TB DI ON D.ID_DISTRITO = DI.ID_DISTRITO
    WHERE D.ID_DIRECCION = p_id_direccion;
    RETURN v_distrito;
...
PROCEDURE FIDE_DIRECCION_TB_LISTAR_DESCRIPCIONES_SP (
...
FUNCTION FIDE_CLIENTES_TB_OBTENER_ID_CLIENTE_FN (
    p_nombre_cliente IN VARCHAR2
) RETURN NUMBER IS
    v_id_cliente NUMBER;
BEGIN
...
PROCEDURE FIDE_SERVICIOS_TB_LISTAR_SP(
    p_resultado OUT SYS_REFCURSOR
) AS
BEGIN
    OPEN p_resultado FOR
...
PROCEDURE FIDE_SERVICIOS_TB_INACTIVAR_SP (
    p_nombre IN VARCHAR2
) AS
...
FUNCTION FIDE_SERVICIOS_TB_OBTENER_ID_SERVICIO_FN (
...
PROCEDURE FIDE_BENEFICIO_TB_LISTAR_SP (
    p_resultado OUT SYS_REFCURSOR
)
AS
BEGIN
...
PROCEDURE FIDE_BENEFICIO_TB_INACTIVAR_SP (
    p_detalle_beneficio IN VARCHAR2
) AS
    v_id_beneficio NUMBER;
    v_id_estado NUMBER;
...
PROCEDURE FIDE_PRODUCTO_TB_LISTAR_SP (
    p_resultado OUT SYS_REFCURSOR
)
AS
BEGIN
...
PROCEDURE FIDE_PRODUCTO_TB_INACTIVAR_SP (
    p_id_producto IN NUMBER
)
AS
    v_id_estado NUMBER;
...
FUNCTION FIDE_PRODUCTO_TB_OBTENER_ID_PRODUCTO_FN (
...
PROCEDURE FIDE_PRODUCTO_TB_LISTAR_NOMBRES_SP (
    p_resultado OUT SYS_REFCURSOR
)
AS
BEGIN
...
PROCEDURE FIDE_INVENTARIO_TB_LISTAR_SP (
    p_resultado OUT SYS_REFCURSOR
)
AS
BEGIN
...
PROCEDURE FIDE_INVENTARIO_TB_INACTIVAR_SP (
    p_id_inventario IN NUMBER
)
AS
    v_id_estado NUMBER;
...
-- Módulo Proveedores
FUNCTION FIDE_PROVEEDOR_TB_OBTENER_ID_PROVEEDOR_FN(p_nombre VARCHAR2)
RETURN NUMBER IS
    v_id NUMBER;
BEGIN
...
PROCEDURE FIDE_PROVEEDOR_TB_LISTAR_SP (
    p_resultado OUT SYS_REFCURSOR
)
AS
BEGIN
...
PROCEDURE FIDE_PROVEEDOR_TB_INACTIVAR_SP (
    p_id_proveedor IN NUMBER
)
AS
    v_id_estado NUMBER;
...
PROCEDURE FIDE_PROVEEDOR_TB_LISTAR_NOMBRES_SP (
    p_resultado OUT SYS_REFCURSOR
)
AS
BEGIN
...
PROCEDURE FIDE_ORDENES_COMPRA_TB_LISTAR_SP (
    p_resultado OUT SYS_REFCURSOR
)
AS
BEGIN
...
PROCEDURE FIDE_ORDENES_COMPRA_TB_INACTIVAR_SP (
    p_id_orden IN NUMBER
)
AS
    v_id_estado NUMBER;
...
PROCEDURE FIDE_METODO_PAGO_TB_LISTAR_SP (
    p_resultado OUT SYS_REFCURSOR
)
AS
BEGIN
...
PROCEDURE FIDE_METODO_PAGO_TB_INACTIVAR_SP (
    p_id_metodo_pago IN NUMBER
)
AS
    v_id_estado NUMBER;
...
FUNCTION FIDE_METODO_PAGO_TB_OBTENER_ID_METODO_PAGO_FN(
...
PROCEDURE FIDE_HISTORIAL_PAGOS_TB_LISTAR_SP (
    p_resultado OUT SYS_REFCURSOR
)
AS
BEGIN
...
PROCEDURE FIDE_HISTORIAL_PAGOS_TB_INACTIVAR_SP (
    p_id_pago IN NUMBER
)
AS
    v_id_estado NUMBER;
...
PROCEDURE FIDE_FACTURAS_TB_LISTAR_SP (
    p_resultado OUT SYS_REFCURSOR
)
AS
BEGIN
...
PROCEDURE FIDE_FACTURAS_TB_INACTIVAR_SP (
    p_id_factura IN NUMBER
)
AS
    v_id_estado NUMBER;
...
FUNCTION FIDE_FACTURAS_TB_OBTENER_ID_FACTURA_FN(p_id_factura IN VARCHAR2)
RETURN NUMBER IS
    v_id NUMBER;
BEGIN
    SELECT ID_FACTURA INTO v_id
    FROM FIDE_FACTURAS_TB
    WHERE TO_CHAR(ID_FACTURA) = p_id_factura;
    RETURN v_id;
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        RETURN NULL;
...
PROCEDURE FIDE_DETALLE_FACTURAS_TB_LISTAR_SP (
    p_resultado OUT SYS_REFCURSOR
)
AS
BEGIN
...
PROCEDURE FIDE_DETALLE_FACTURAS_TB_INACTIVAR_SP (
    p_id_detalle IN NUMBER
)
AS
    v_id_estado NUMBER;
...
BEGIN
    ...
    WHERE UPPER(USUARIO) = UPPER(p_usuario)
      AND UPPER(CLAVE) = UPPER(p_clave)
      AND ID_ESTADO = (SELECT ID_ESTADO FROM FIDE_ESTADO_TB WHERE UPPER(DESCRIPCION) = 'ACTIVO');
